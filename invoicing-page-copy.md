...
**Subheadline:**
Build, send, and track invoices from the same platform you bank with. Know the moment you get paid — no refreshing your bank, no reconciling spreadsheets, no chasing.
...
## 2. THREE-COLUMN BENEFITS

**Section headline:**
Why entrepreneurs invoice with neno
...
*Body:* See what's paid, what's overdue, and what's coming in — all in one dashboard. No spreadsheets, no guesswork, no end-of-month surprises.
...
**Step 1:**
*Headline:* Build your invoice
*Body:* Pick a client from your address book, add line items, select your tax rate, and set payment terms. Add your logo and brand colours, then preview it as a polished PDF before it goes anywhere.

**Step 2:**
*Headline:* Send it directly
*Body:* Send from your business email with one click. Your client receives a professional email with a PDF attachment and a secure link to view and pay.
...
**Visual:** *[Invoice builder UI — split view showing the form on the left and live PDF preview on the right]*

---

## 5. 6-GRID FEATURE SECTION

**Section headline:**
Everything you need to get paid

**Feature 1:**
*Headline:* Branded, professional PDFs
*Body:* Every invoice generates a clean PDF with your logo, colours, and company details. Download it, attach it to an email, or let neno send it for you.
...
*Body:* See exactly what happened and when. Created, sent, viewed, paid — every event is logged so you never have to wonder about the status of an invoice.
...
*Body:* When a client pays, neno recognises the transaction and marks the invoice as paid — instantly. No manual reconciliation, no checking your bank. You just get notified that the money has arrived.

---

## 6. 3-COLUMN TRUST SECTION
...
*Body:* When your invoicing and your bank account live in the same platform, reconciliation happens automatically. Payments match to invoices without manual effort.
...
**Pricing card:**
*Price:* Included with your neno account
*Description:* Professional invoicing with no per-invoice fees and no hidden costs.
...
**Q: What happens if a client doesn't pay on time?**
Neno sends automatic payment reminders on a schedule you control. You can see overdue invoices at a glance on your dashboard and follow up manually if needed.
...
**Body:**
Create professional invoices, send them in one click, and get paid faster — all from the same platform you run your business on.
